...
const ROID_SIZE = 100; // starting size (pixels)
const ROID_SPD = 50; // max starting speed (pixels/sec)
const ROID_VERT = 10; // ave number vertices
// Collision
const SHIP_BLINK_DUR = 0.1; // duration (sec)single blink when invisibility
const SHIP_EXPLODE_DUR = 0.3; // duration (sec) explosion
const SHIP_INV_DUR = 3; // duration (sec) ship's invisibility
const SHIP_SIZE = 30; // ship height pixels
const SHIP_THRUST = 5; // ship acceleration (pixels/sec/sec)
const SHIP_TURN_SPD = 360; // turn speed degrees/sec
